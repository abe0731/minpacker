...
class AirportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airport" do
    assert_difference('Airport.count') do
      post airports_url, params: { airport: { city_id: @airport.city_id, iata_cd: @airport.iata_cd, map: @airport.map, name1: @airport.name1, name2: @airport.name2, name3: @airport.name3, prefecture_id: @airport.prefecture_id } }
    end
  ...
  test "should update airport" do
    patch airport_url(@airport), params: { airport: { city_id: @airport.city_id, iata_cd: @airport.iata_cd, map: @airport.map, name1: @airport.name1, name2: @airport.name2, name3: @airport.name3, prefecture_id: @airport.prefecture_id } }
