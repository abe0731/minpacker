...
class PrefecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prefecture" do
    assert_difference('Prefecture.count') do
      post prefectures_url, params: { prefecture: { map: @prefecture.map, name1: @prefecture.name1, name2: @prefecture.name2, name3: @prefecture.name3 } }
    end
  ...
  test "should update prefecture" do
    patch prefecture_url(@prefecture), params: { prefecture: { map: @prefecture.map, name1: @prefecture.name1, name2: @prefecture.name2, name3: @prefecture.name3 } }
