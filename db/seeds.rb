...
require "csv"
# CSV.foreach("../rent_unit.csv") do |row|
#   RentUnit.create(:name => row[0])
# end
# CSV.foreach("../stay_unit.csv") do |row|
#   StayUnit.create(:name => row[0])
# end
# CSV.foreach("../prefecture.csv") do |row|
...
# end
# CSV.foreach("../station.csv") do |row|
